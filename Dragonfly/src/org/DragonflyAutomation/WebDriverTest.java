...
class WebDriverTest {
	...
	static void WebDriverTestRun() {
		...
		System.out.println("frame 0 browserInnerWidth " + browserInnerWidth);
		System.out.println("frame 0 browserInnerHeight " + browserInnerHeight);
		...
		browserInnerWidth = (long) ((JavascriptExecutor) webDriver).executeScript("return Math.round(window.outerWidth - window.innerWidth);");
		browserInnerHeight = (long) ((JavascriptExecutor) webDriver).executeScript("return Math.round(window.outerHeight - window.innerHeight);");
		System.out.println("frame 1 browserInnerWidth " + browserInnerWidth);
		System.out.println("frame 1 browserInnerHeight " + browserInnerHeight);
		//System.out.println("html");
		...
		System.out.println("frame 2 browserInnerWidth " + browserInnerWidth);
		System.out.println("frame 2 browserInnerHeight " + browserInnerHeight);
		//		System.out.println("html");
		//		webElement = webDriver.findElement(By.xpath("/html"));
		//		getScreenXY(webDriver, webElement, browser);
		...
		System.out.println("frame 3 browserInnerWidth " + browserInnerWidth);
		System.out.println("frame 3 browserInnerHeight " + browserInnerHeight);
		//System.out.println("html");
		//webElement = webDriver.findElement(By.xpath("/html"));
		//getScreenXY(webDriver, webElement, browser);
		webElement = webDriver.findElement(By.id("page1_title"));
...
//		+ "		}\n"
	...
	static void getFrameXY(WebDriver webDriver, WebElement webElement, String browser) {
		...
		+ "	};\n"
		+ "}\n"
	    + "return getPosition(arguments[0]);";
		//@formatter:on
		//System.out.println(javaScript);
		Map<String, Long> FrameXY = (Map<String, Long>) javascriptExecutor.executeScript(javaScript, webElement);
