...
public class Dragonfly {
	...
	//		  String run(String strPattern, String strActualValue) throws ExceptionValueNotMatched {
	...
	//	}
	//	  class VerifyMatch {
	//		  String run(String strActual, String strExpected) throws ExceptionValueNotMatched {
